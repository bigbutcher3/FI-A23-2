...
(function (d) {
    ...
    function x(a, b, c) {
        d.fn.animate ? a.stop().fadeOut(b, c) : (a.css("display", "none"), c &&
        c.call(a))
    }

    function z(a, b) {
        var c = new i.Api(a), e = b ? b : c.init().buttons || i.defaults.buttons;
        return (new p(c, e)).container()
    }

    var i = d.fn.dataTable, C = 0, D = 0, l = i.ext.buttons, p = function (a, b) {
        if (!(this instanceof p)) return function (b) {
            return (new p(b, a)).container()
        };
        "undefined" === typeof b && (b = {});
        !0 === b && (b = {});
        d.isArray(b) && (b = {buttons: b});
        this.c = d.extend(!0, {}, p.defaults, b);
        b.buttons && (this.c.buttons = b.buttons);
        this.s = {dt: new i.Api(a), buttons: [], listenKeys: "", namespace: "dtb" + C++};
        this.dom = {
            container: d("<" +
    ...
    d.extend(p.prototype, {
        action: function (a, b) {
            ...
            if ("string" === typeof b) {
                for (var e = b.split("-"), d = this.s, c = 0, f = e.length - 1; c < f; c++) d =
                    d.buttons[1 * e[c]];
                c = d.buttons;
                b = 1 * e[e.length - 1]
            }
            this._expandButton(c, a, d !== m, b);
            this._draw();
            return this
        }, container: function () {
            ...
            b = 0;
            for (c = a.length; b < c; b++) if (a.inst ===
                this) {
                a.splice(b, 1);
                break
            }
            ...
            var c = this._nodeToButton(a);
            d(c.node).removeClass(this.c.dom.button.disabled).removeAttr("disabled");
            return this
        }, name: function () {
            return this.c.name
        }, node: function (a) {
            ...
            if (b === m) return d(e.node).hasClass("processing");
            ...
            var c = this._nodeToButton(a), e = this.c.dom.collection.buttonLiner,
                ...
                g = this.s.dt, f = d(c.node), h = function (a) {
                    return "function" === typeof a ? a(g, f, c.conf) : a
                };
            if (b === m) return h(c.conf.text);
            c.conf.text = b;
            e ? f.children(e).html(h(b)) : f.html(h(b));
            return this
            ...
            for (var g =
                ...
                var n = this._resolveExtends(b[h]);
                if (n) if (d.isArray(n)) this._expandButton(a, n, c, e); else {
                    var j = this._buildButton(n, c);
                    j && (e !== m && null !== e ? (a.splice(e, 0, j), e++) : a.push(j), j.conf.buttons && (j.collection = d("<" + this.c.dom.collection.tag + "/>"), j.conf._collection = j.collection, this._expandButton(j.buttons, j.conf.buttons, !0, e)), n.init && n.init.call(g.button(j.node), g, d(j.node), n), f++)
                }
            }
        }, _buildButton: function (a, b) {
            var c = this.c.dom.button, e = this.c.dom.buttonLiner,
                g = this.c.dom.collection, f = this.s.dt, h = function (b) {
            ...
            var k = function (a, b, c, e) {
                ...
                }, g = a.tag || c.tag, n = a.clickBlurs === m ? !0 : a.clickBlurs,
            ...
            e.tag ? (g = d("<" + e.tag + "/>").html(h(a.text)).addClass(e.className), "a" === e.tag.toLowerCase() && g.attr("href", "#"), j.append(g)) : j.html(h(a.text));
            ...
            if (!b._buttonsHandled) {
                var c = function (e) {
                    for (var g = 0, f = e.length; g < f; g++) {
                        ...
                        if (h.key) if (h.key === a) b._buttonsHandled = !0, d(k).click(); else if (d.isPlainObject(h.key) && h.key.key === a && (!h.key.shiftKey || b.shiftKey)) if (!h.key.altKey || b.altKey) if (!h.key.ctrlKey ||
            ...
            for (var b = this.s.dt, c, e, g = function (c) {
                ...
                if (h) {
                    a.buttons || (a.buttons = []);
                    c = 0;
                    for (e = h.length; c < e; c++) a.buttons.push(h[c]);
                ...
                if (h =
                    ...
                    a.buttons || (a.buttons = []);
                    c = 0;
                    for (e = h.length; c < e; c++) a.buttons.splice(c, 0, h[c]);
            ...
            c.length && (f = c.eq(0), h());
            c = d("<div/>").addClass("dt-button-collection").addClass(g.collectionLayout).css("display",
                "none");
            ...
            w(c.insertAfter(f));
            var e = d(b.table().container()), k = c.css("position");
            "dt-container" === g.align && (f = f.parent(), c.css("width", e.width()));
            if ("absolute" === k && (c.hasClass(g.rightAlignClassName) || c.hasClass(g.leftAlignClassName) || "dt-container" ===
                g.align)) {
                var n = f.position();
                c.css({top: n.top + f.outerHeight(), left: n.left});
                var j = c.outerHeight(), i = e.offset().top + e.height(), t = n.top + f.outerHeight() + j, i = t - i,
                    t = n.top - j, m = e.offset().top, l = n.top - j - 5;
                (i > m - t || g.dropup) && -l < m && c.css("top", l);
                var n = e.offset().left, e = e.width(), e = n + e, k = c.offset().left, s = c.width(), s = k + s,
                    o = f.offset().left, u = f.outerWidth(), u = o + u, o = 0;
                c.hasClass(g.rightAlignClassName) ? (o = u - s, n > k + o && (k = n - (k + o), e -= s + o, o = k > e ? o + e : o + k)) : (o = n - k, e < s + o && (k = n - (k + o), e -= s + o, o = k > e ? o + e : o + k));
                c.css("left",
                    c.position().left + o)
            } else "absolute" === k ? (n = f.position(), c.css({
                top: n.top + f.outerHeight(),
                left: n.left
            }), j = c.outerHeight(), k = f.offset().top, o = 0, o = f.offset().left, u = f.outerWidth(), u = o + u, k = c.offset().left, s = a.width(), s = k + s, l = n.top - j - 5, i = e.offset().top + e.height(), t = n.top + f.outerHeight() + j, i = t - i, t = n.top - j, m = e.offset().top, (i > m - t || g.dropup) && -l < m && c.css("top", l), o = "button-right" === g.align ? u - s : o - k, c.css("left", c.position().left + o)) : (k = c.height() / 2, k > d(q).height() / 2 && (k = d(q).height() / 2), c.css("marginTop",
                -1 * k));
            g.background && p.background(!0, g.backgroundClassName, g.fade, f);
            d("div.dt-button-background").on("click.dtb-collection", function () {
            });
            d("body").on("click.dtb-collection", function (b) {
                var c = d.fn.addBack ? "addBack" : "andSelf", e = d(b.target).parent()[0];
                (!d(b.target).parents()[c]().filter(a).length && !d(e).hasClass("dt-buttons") || d(b.target).hasClass("dt-button-background")) && h()
    ...
    p.background = function (a, b, c, e) {
        c === m && (c = 400);
        e || (e = r.body);
        a ? w(d("<div/>").addClass(b).css("display", "none").insertAfter(e), c) : x(d("div." + b), c, function () {
            d(this).removeClass(b).remove()
        })
    };
    p.instanceSelector = function (a, b) {
        if (a === m || null === a) return d.map(b, function (a) {
            return a.inst
        });
        var c = [], e = d.map(b, function (a) {
            return a.name
        }), g = function (a) {
            if (d.isArray(a)) for (var h = 0, k = a.length; h < k; h++) g(a[h]); else "string" === typeof a ?
                -1 !== a.indexOf(",") ? g(a.split(",")) : (a = d.inArray(d.trim(a), e), -1 !== a && c.push(b[a].inst)) : "number" === typeof a && c.push(b[a].inst)
        };
        g(a);
        return c
    };
    p.buttonSelector = function (a, b) {
        ...
        collection: {
            text: function (a) {
                return a.i18n("buttons.collection",
                    "Collection")
            }, className: "buttons-collection", init: function (a, b) {
                ...
                extend: "collection", text: function (a) {
                    ...
                    return {
                        text: c[b], className: "button-page-length", action: function (b, c) {
                            ...
                            var g = this, c = function () {
                                g.active(b.page.len() === a)
                            };
    ...
    i.Api.register("buttons()",
        function (a, b) {
            ...
            var c = this.iterator(!0, "table", function (c) {
                if (c._buttons) return p.buttonSelector(p.instanceSelector(a, c._buttons), b)
            }, !0);
            c._groupSelector = a;
            return c
        });
    ...
    i.Api.register("buttons().containers()", function () {
        ...
        this.iterator(!0, "table", function (c) {
            if (c._buttons) for (var c = p.instanceSelector(b, c._buttons), d = 0, g = c.length; d < g; d++) a = a.add(c[d].container())
        });
        return a
    });
    ...
    i.Api.register("button().add()", function (a, b) {
        var c = this.context;
        c.length && (c = p.instanceSelector(this._groupSelector, c[0]._buttons), c.length && c[0].add(b, a));
    ...
    i.Api.register("buttons.info()", function (a, b, c) {
        var e = this;
        if (!1 === a) return this.off("destroy.btn-info"), x(d("#datatables_buttons_info"), 400, function () {
            d(this).remove()
        }), clearTimeout(v), v = null, this;
        v && clearTimeout(v);
        d("#datatables_buttons_info").length && d("#datatables_buttons_info").remove();
        w(d('<div id="datatables_buttons_info" class="dt-button-info"/>').html(a ? "<h2>" + a + "</h2>" : "").append(d("<div/>")["string" === typeof b ? "html" : "append"](b)).css("display", "none").appendTo("body"));
        c !== m && 0 !== c &&
    ...
    i.Api.register("buttons.exportData()", function (a) {
        if (this.context.length) {
            ...
            b.select && "function" === typeof b.select.info && f.selected === m && b.rows(c.rows, d.extend({selected: !0}, f)).any() && d.extend(f, {selected: !0});
            for (var f = b.rows(c.rows, f).indexes().toArray(), h = b.cells(f, c.columns), f = h.render(c.orthogonal).toArray(), h = h.nodes().toArray(), k = a.length, n = [], j = 0, l = 0, p = 0 < k ? f.length / k : 0; l < p; l++) {
                for (var r = [k], q = 0; q < k; q++) r[q] = c.format.body(f[j], l, q, h[j]), j++;
                n[l] = r
            }
            a = {
                header: a,
    ...
    i.Api.register("buttons.exportInfo()", function (a) {
        ...
        b === m || null === b ? b = null : (-1 !== b.indexOf("*") && (b = d.trim(b.replace("*", d("head > title").text()))), b = b.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, ""), (c = y(c.extension)) || (c = ""), b += c);
        c = y(a.title);
    ...
    d.fn.dataTable.Buttons = p;
    d.fn.DataTable.Buttons = p;
    d(r).on("init.dt plugin-init.dt",
        function (a, b) {
            if ("dt" === a.namespace) {
                var c = b.oInit.buttons || i.defaults.buttons;
                c && !b._buttons && (new p(b, c)).container()
            }
        });
